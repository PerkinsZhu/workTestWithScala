...
/**
 * Created by PerkinsZhu on 2018/1/23 11:45
 **/
...
public class EhcacheTest {
    ...
    public void testQueue(){
        ...
        //加载EhCache配置文件
        InputStream in = EhcacheTest.class.getClassLoader().getResourceAsStream("ehcache-default.xml");
    ...
    public void testCacheManager() {
        ...
        Cache cache = cm.getCache("task-cache");
//        cache.put(new Element("name","jack"));
        cache.getKeys().forEach((Object key) ->{System.out.println(key);});
