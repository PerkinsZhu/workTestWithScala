...
public class MyRSA {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("PRIVATE_KEY:\n\t" + Base64.encodeBase64String(keyMap.get(PRIVATE_KEY)));
        System.out.println("PUBLIC_KEY:\n\t" + Base64.encodeBase64String(Base64.decodeBase64(Base64.encodeBase64String(keyMap.get(PRIVATE_KEY)))));
        System.out.println("PRIVATE_KEY:\n\t" + Base64.encodeBase64String(keyMap.get(PUBLIC_KEY)));
